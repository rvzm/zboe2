...
export const ITEMS = {
  ...
  "Baseball Bat":  { name: "Baseball Bat",  type: "weapon", section: "Melee", desc: "A solid bat. Smacks zombies hard." },
  "Spiked Bat":    { name: "Spiked Bat",    type: "weapon", section: "Melee", desc: "A bat with spikes. Smacks zombies harder." },
  "Crossbow":      { name: "Crossbow",      type: "weapon", section: "Ranged", desc: "A quiet ranged weapon. Fires bolts with deadly accuracy." },
  ...
  "bronze pickaxe":     { name: "Bronze Pickaxe",     type: "tool", tier: "Bronze", section: "Tools",     desc: "Improved but crude pickaxe.",                    value: 125,  shop: { cost: 125, currency: "gold" } },
  "iron pickaxe":       { name: "Iron Pickaxe",       type: "tool", tier: "Iron", section: "Tools",       desc: "A proper pickaxe. Smashes stone and ore.",       value: 200,  shop: { cost: 200, currency: "gold" } },
...
export const RECIPES = [
  ...
  { key: "craft_zombie_head",   label: "Craft Zombie Helm",       skill: "smithing", level: 10, station: "arcane_table", requires: "hammer", inputs: { "zombie head": 1, "zombie brain": 1, "zombie eye": 1, "syllic bar": 1 }, output: "zombie helm",       xp: 60, timer: 45, category: "misc" },
  { key: "craft_zombie_torso",  label: "Craft Zombie Chestplate", skill: "smithing", level: 10, station: "arcane_table", requires: "hammer", inputs: { "zombie torso": 1, "zombie heart": 1, "zombie skin": 2, "syllic bar": 1, "syllic plate": 1 }, output: "zombie chestplate", xp: 90, timer: 60, category: "misc" },
  { key: "craft_zombie_legs",   label: "Craft Zombie Platelegs",  skill: "smithing", level: 10, station: "arcane_table", requires: "hammer", inputs: { "zombie leg": 2, "zombie skin": 1, "syllic bar": 1, "syllic plate": 1 }, output: "zombie platelegs", xp: 90, timer: 60, category: "misc" },
  { key: "craft_zombie_boots",  label: "Craft Zombie Boots",      skill: "smithing", level: 10, station: "arcane_table", requires: "hammer", inputs: { "zombie leg": 1, "zombie skin": 1, "syllic bar": 1 }, output: "zombie boots",     xp: 60, timer: 45, category: "misc" },
  { key: "craft_zombie_hands",  label: "Craft Zombie Gauntlets",  skill: "smithing", level: 10, station: "arcane_table", requires: "hammer", inputs: { "zombie arm": 1, "zombie skin": 1, "syllic bar": 1 }, output: "zombie gauntlets", xp: 60, timer: 45, category: "misc" },
  { key: "craft_zombie_shield", label: "Craft Zombie Shield",     skill: "smithing", level: 10, station: "arcane_table", requires: "hammer", inputs: { "zombie torso": 1, "zombie stomach": 1, "zombie intestine": 1, "syllic bar": 1, "syllic plate": 1 }, output: "zombie shield", xp: 90, timer: 60, category: "misc" },
